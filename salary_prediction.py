...
class SalaryModel:
    def __init__(self, path='salary_model.pcl'):
        ...
        'age_18-21', 'age_22-24', 'age_25-29', 'age_30-34', 'age_35-39', 'age_40-44', 'age_45-49', 'age_50-54', 'age_55-59', 'age_60+',
        'country_Australia', 'country_Brazil', 'country_Canada', 'country_China', 'country_France', 'country_Germany', 'country_India', 'country_Italy',
        'country_Japan', 'country_Mexico', 'country_Other', 'country_Russia', 'country_Spain', 'country_United Kingdom of Great Britain and Northern Ireland', 'country_United States of America',
        'role_Business Analyst', 'role_Consultant', 'role_Data Analyst', 'role_Data Engineer', 'role_Data Scientist', 'role_Other', 'role_Research Scientist', 'role_Software Engineer', 'role_Student',
        'employer_industry_Academics/Education', 'employer_industry_Accounting/Finance', 'employer_industry_Computers/Technology', 'employer_industry_Government/Public Service', 'employer_industry_Insurance/Risk Assessment',
        'employer_industry_Medical/Pharmaceutical', 'employer_industry_Online Service/Internet-based Services', 'employer_industry_Other', 'years_experience_0-1', 'years_experience_1-2', 'years_experience_10-15', 'years_experience_15+',
    ...
    def form_input_to_sample(self, age, country, industry, role, experience, q11):
        sample = pd.DataFrame(np.zeros((1, self.n_cols)), columns=features.columns)
        sample['age_' + age] = 1
